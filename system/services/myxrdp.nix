...
let
  ...
  confDir = pkgs.runCommand "xrdp.conf" { preferLocalBuild = true; } ''
    ...
    # --replace ListenPort=3350 ListenPort=tcp://5553 \
    # --replace-fail ListenAddress=127.0.0.1 ListenAddress=::1 \
    # --replace-fail EnableSyslog=1 EnableSyslog=0 \
    substituteInPlace $out/sesman.ini \
      --replace-fail LogFile=xrdp-sesman.log LogFile=/home/nyx/aaaa \
